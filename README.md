# Data-Science-Spring2025 Probability & Statistics I & II
...
selected function(chisq.test, pData, rep, colnames, glimpse(df), factor, eBayes, decideTests, topTable, read.tree, plot, str, write.tree, library, setwd, ReadAffy, exprs, read.csv, read.delim, write.table, roundPhylogram, unroot, str, write.tree, RMA, read.table, head(), table()), mutate(), factor(), levels().
